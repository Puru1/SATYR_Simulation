...
%Wheel(0) -> CM1 
R0cm1 = eye(3);
v0cm1 = [0;0;.2169*L1]; %  Translation from frame wheel to frame knee (written in frame wheel)
HTM0cm1 = [[R0cm1 v0cm1] 
         [0 0 0 1]];
...
write_fcn_m('fnc_PosK.m',{'q','L'},[],{PosK,'PosK'});
write_fcn_m('fnc_PosCM2.m',{'q','L'},[],{PosCM2,'PosCM2'});
write_fcn_m('fnc_PosH.m',{'q','L'},[],{PosH,'PosH'});
write_fcn_m('fnc_PosCoM_R.m',{'q','L'},[],{PosR,'PosR'});
write_fcn_m('fnc_PosT.m',{'q','L'},[],{PosT,'PosT'});
