...
L_total = CoM_Standing(3) - .03; % .3733 -.03
M_total = sum(M);
% Linearizing around the normal compression of the spring under gravity
% p.Ks = (M_total*p.g)/(2*p.deltaL);
l_h_lin = L_total;

% Linearizing around chosen compression 
% l_h_lin = L_total - .03;
