...
[p.theta2_num,p.theta3_num] = solveJointAngles(p.theta1_num,.97,p.M(2:4),p.L,2);
...
xlabel('Time (sec)');
ylabel('Force (N)');
>>>>>>> adding_folders:SATYR Dynamics/Ver3_full_curr_working/main.m
% ylim([-10,200]);